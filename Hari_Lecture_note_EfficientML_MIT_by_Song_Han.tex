...
\subsubsection{Input layer \(\to\) Hidden layer}
\[
...
\subsubsection{Hidden layer \(\to\) Output layer}
\[
...
\bigskip
\subsection{Backpropagation: Output‐Layer Gradients}
...
\subsubsection{Gradient w.r.t.\ \(W^{[2]}\)}
...
\subsubsection{Gradient w.r.t.\ \(b^{[2]}\)}
...
\subsubsection{Gradient w.r.t.\ \(A^{[1]}\) (propagate to previous layer)}
...
\bigskip
\subsection{Backpropagation: Hidden‐Layer Gradients}
...
\subsubsection{Gradient w.r.t.\ \(b^{[1]}\)}
...
\subsubsection{Parameter Updates (Gradient Descent)}
...
\bigskip
\subsection{Generalization to More Layers}
