...
\title{Neural Network from Scratch with NumPy}
...
\begin{center}
    \includegraphics[width=\textwidth,height=0.3\textheight,keepaspectratio]{screenshot_placeholder_1.png}
    
    \vspace{0.5cm}
    \includegraphics[width=\textwidth,height=0.3\textheight,keepaspectratio]{screenshot_placeholder_2.png}
    
    \vspace{0.5cm}
    \includegraphics[width=\textwidth,height=0.3\textheight,keepaspectratio]{screenshot_placeholder_3.png}
\end{center}
